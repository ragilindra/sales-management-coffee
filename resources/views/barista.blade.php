...
@section('content')
    ...
    <main>
        ...
        <div class="container-fluid">
            ...
            <div class="card mb-4">
                <div class="row">
                    <div class="col">
                        <h5 class="mt-4 ml-3">Data Barista</h5>
                    </div>
                    <div class="col text-right">
                        <button type="button" class="btn btn-sm btn-primary mt-4 mr-4" data-toggle="modal"
                            data-target="#tambahBarista"><i class="fas fa-plus"></i> Tambah Barista Baru</button>
                    </div>
                </div>
                            ...
                            <tbody>
                                @foreach ($barista as $br)
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-sm btn-warning ml-2 mt-1"
                                                style="width: 60px" data-toggle="modal"
                                                data-target="#edit{{ $br['id'] }}">Edit</button>
                                            <button type="button" class="btn btn-sm btn-danger ml-2 mt-1"
                                                style="width: 60px" data-toggle="modal"
                                                data-target="#delete{{ $br['id'] }}">Hapus</button>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
    ...
    <!-- modals -->
    <!-- Tambah Modal -->
    <div class="modal fade" id="tambahBarista" data-backdrop="static" data-keyboard="false" tabindex="-1"
    ...
    <!-- Hapus Modal -->
    @foreach ($barista as $br)
        <div class="modal fade" id="delete{{ $br['id'] }}" data-backdrop="static" data-keyboard="false" tabindex="-1"
            aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="staticBackdropLabel">Apakah Anda yakin ingin menghapus data Barista?
                        </h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
        ...
        <!-- End Hapus Modal -->
        <!-- Edit Modal -->
        <div class="modal fade" id="edit{{ $br['id'] }}" data-backdrop="static" data-keyboard="false" tabindex="-1"
            aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <form action="/editBarista/<?= $br['id'] ?>" method="post">
                        ...
                        <div class="modal-body">
                            ...
                            <input type="text" name="id" id="" class="col" value="<?= $br['id'] ?>"
                                readonly><br><br>
                            <label for="id">Nama</label>
                            <input type="text" name="nama" id="" class="col"
                                value="<?= $br['nama'] ?>"><br><br>
                            <label for="id">Gaji</label>
                            <input type="text" name="gaji" id="" class="col"
                                value="<?= $br['gaji'] ?>"><br><br>
                            <label for="id">Shift</label>
                            <input type="text" name="shift" id="" class="col"
                                value="<?= $br['shift'] ?>"><br><br>
                        </div>
                        <div class="modal-footer">
                            <a href="/barista" class="btn btn-secondary">Batal</a>
