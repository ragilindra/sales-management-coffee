...
@section('content')
    <main>
        <div class="container-fluid">
            ...
            <div class="card mb-4">
                <div class="row">
                    <div class="col">
                        <h5 class="mt-4 ml-3">Data Penjualan</h5>
                    </div>
                    <div class="col text-right">
                        <button type="button" class="btn btn-sm btn-primary mt-4 mr-4" data-toggle="modal"
                            data-target="#tambah"><i class="fas fa-plus"></i> Tambah Penjualan Baru</button>
                    </div>
                </div>
                <div class="input-group mt-3">
                    <p class="mt-3 my-auto ml-3 rounded p-2 shadow-sm" style="background-color: #a4cada" id="jual">
                        <span class="p-1 rounded" style="background-color: #cbd2d4"></span></p>
                </div>
                <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-sm btn-warning ml-2" style="width: 60px"
                                                data-toggle="modal" data-target="#edit{{ $pj['id'] }}">Edit</button>
                                            <button type="button" class="btn btn-sm btn-danger ml-2" style="width: 60px"
                                                data-toggle="modal" data-target="#delete{{ $pj['id'] }}">Hapus</button>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
    ...
    @foreach ($menu as $mn)
        @foreach ($penjualan as $pj)
            <div class="modal fade" id="delete{{ $pj['id'] }}" data-backdrop="static" data-keyboard="false"
            ...
            <div class="modal fade" id="edit{{ $pj['id'] }}" data-backdrop="static" data-keyboard="false" tabindex="-1"
                    ...
                    <div class="modal-content">
                        ...
                        <form action="/editPenjualan/<?= $pj['id'] ?>" method="post">
                            ...
                            <div class="modal-body">
                                ...
                                <input type="text" name="id" id="" class="col"
                                    value="<?= $mn['id'] ?>" readonly><br><br>
                                <label for="id">Nama Barang</label>
                                <input type="text" name="nama_barang" id="" class="col"
                                    value="<?= $pj['nama_barang'] ?>" readonly><br><br>
                                <label for="id">Jumlah</label>
                                <input type="text" name="jumlah" id="" class="col"
                                    value="<?= $pj['jumlah'] ?>"><br><br>
                            </div>
                            <div class="modal-footer">
                                <a href="/penjualan" class="btn btn-secondary">Batal</a>
