...
@section('content')
    ...
    <main>
        <div class="container-fluid">
            ...
            <div class="card mb-4">
                <div class="row">
                    <div class="col">
                        <h5 class="mt-4 ml-3">Daftar Menu</h5>
                    </div>
                    <div class="col text-right">
                        <button type="button" class="btn btn-sm btn-primary mt-4 mr-4" data-toggle="modal"
                            data-target="#tambah"><i class="fas fa-plus"></i> Tambah Menu Baru</button>
                    </div>
                </div>
    ...
    <!-- modals -->
    @foreach ($menu as $mn)
        <div class="modal fade" id="delete{{ $mn['id'] }}" data-backdrop="static" data-keyboard="false" tabindex="-1"
        ...
        <div class="modal fade" id="edit{{ $mn['id'] }}" data-backdrop="static" data-keyboard="false" tabindex="-1"
            aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <form action="/editMenu/<?= $mn['id'] ?>" method="post">
                        ...
                        <div class="modal-body">
                            ...
                            <input type="text" name="id" id="" class="col" value="<?= $mn['id'] ?>"
                                readonly><br><br>
                            <label for="id">Nama Menu</label>
                            <input type="text" name="nama_menu" id="" class="col"
                                value="<?= $mn['nama_menu'] ?>"><br><br>
                            ...
                            <input type="text" name="harga" id="" class="col"
                                value="<?= $mn['harga'] ?>"><br><br>
                            ...
                            <input type="text" name="untung" id="" class="col"
                                value="<?= $mn['untung'] ?>"><br><br>
                            @if ($errors->first('harga'))
                                <div class="alert alert-danger">
                                    {{ $errors->first('untung') }}
                                </div>
