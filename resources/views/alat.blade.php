...
<main>
    ...
    <div class="card mb-4">
        ...
        <div class="col text-right">
            <button type="button" class="btn btn-sm btn-primary mt-4 mr-4" data-toggle="modal" data-target="#tambah"><i class="fas fa-plus"></i> Tambah Alat Baru</button>
        </div>
        </div>
        ...
        <div class="table-responsive">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= $row['kondisi'] ?></td>
                    <td>
                        <button type="button" class="btn btn-sm btn-warning ml-2" style="width: 60px" data-toggle="modal" data-target="#edit{{$row['id']}}">Edit</button>
                        <button type="button" class="btn btn-sm btn-danger ml-2 mt-1" style="width: 60px" data-toggle="modal" data-target="#delete{{$row['id']}}" >Hapus</button>
                    </td>
                </tr>
                @endforeach
            </tbody>
...
<!-- modals delete -->
@foreach ($alat as $row)
<div class="modal fade" id="delete{{$row['id']}}" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <form action="/editAlat/<?= $row['id'] ?>" method="post">
            ...
            <div class="modal-body">
                ...
                <input type="text" name="id" id="" class="col" value="<?=  $row['id'] ?>" readonly><br><br>
                <label for="id">Nama Alat</label>
                <input type="text" name="nama_alat" id="" class="col" value="<?=  $row['nama_alat'] ?>"><br><br>
                ...
                <input type="text" name="jumlah" id="" class="col" value="<?=  $row['jumlah'] ?>"><br><br>
                ...
                <input type="text" name="satuan" id="" class="col" value="<?=  $row['satuan'] ?>"><br><br>
                ...
                <input type="text" name="kondisi" id="" class="col" value="<?=  $row['kondisi'] ?>"><br><br>
