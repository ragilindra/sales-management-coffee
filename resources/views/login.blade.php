              ...
              <div class="col-lg-5 text-center">
                ...
                @csrf
                  ...
                  <div class="form-group text-left font-italic">
                    ...
                    <input class="form-control py-4 shadow-sm" id="officer_id" name="officer_id" type="text" placeholder="Enter Officer ID" />
                  ...
                  <div class="form-group text-left font-italic">
                    ...
                    <input class="form-control py-4 shadow-sm" id="inputPassword" name="password" type="password" placeholder="Enter password" />
