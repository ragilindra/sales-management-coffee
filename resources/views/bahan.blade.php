...
@section('content')
    <main>
        <div class="container-fluid">
            ...
            <div class="card mb-4">
                <div class="row">
                    <div class="col">
                        <h5 class="mt-4 ml-3">Bahan</h5>
                    </div>
                    <div class="col text-right">
                        <button type="button" class="btn btn-sm btn-primary mt-4 mr-4" data-toggle="modal"
                            data-target="#tambah"><i class="fas fa-plus"></i>Tambah Bahan Baru</button>
                    </div>
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-sm btn-warning ml-2" style="width: 60px"
                                                data-toggle="modal" data-target="#edit{{ $bhn['id'] }}">Edit</button>
                                            <button type="button" class="btn btn-sm btn-danger ml-2 mt-1"
                                                style="width: 60px" data-toggle="modal"
                                                data-target="#delete{{ $bhn['id'] }}">Hapus</button>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
    ...
    <!-- modals -->
    @foreach ($bahan as $bhn)
        <div class="modal fade" id="delete{{ $bhn['id'] }}" data-backdrop="static" data-keyboard="false" tabindex="-1"
        ...
        <div class="modal fade" id="edit{{ $bhn['id'] }}" data-backdrop="static" data-keyboard="false" tabindex="-1"
            aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <form action="/editBahan/<?= $bhn['id'] ?>" method="post">
                        ...
                        <div class="modal-body">
                            ...
                            <input type="text" name="id" id="" class="col" value="<?= $bhn['id'] ?>"
                                readonly><br><br>
                            <label for="id">Nama Bahan</label>
                            <input type="text" name="nama_bahan" id="" class="col"
                                value="<?= $bhn['nama_bahan'] ?>"><br><br>
